...
fun AboutDialog(onDismissRequest: () -> Unit) {
    ...
    val actions = listOf(
        AboutItem(R.string.source_code, Icons.Default.Code, "https://github.com/heberjeur/RecordYou"),
        AboutItem(R.string.author, Icons.Default.Person, "https://github.com/heberjeur"),
        AboutItem(
